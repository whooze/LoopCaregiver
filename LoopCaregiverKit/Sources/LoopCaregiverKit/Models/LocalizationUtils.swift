...
public struct LocalizationUtils {
    ...
    private static func localizedNumberString(input: Double, minFractionalDigits: Int = 0, maxFractionalDigits maxFractionalDigitsUnverified: Int = 0) -> String {
        let maxFractionalDigits = max(minFractionalDigits, maxFractionalDigitsUnverified)
        return input.formatted(
            .number
                .precision(.fractionLength(minFractionalDigits...maxFractionalDigits))
