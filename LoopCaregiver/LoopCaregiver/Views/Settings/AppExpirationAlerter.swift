...
class AppExpirationAlerter {
        ...
        if isTestFlightBuild() {
            dialog = UIAlertController(
                title: NSLocalizedString(
                    "TestFlight Expires Soon",
                    bundle: .main,
                    comment: "The title for notification of upcoming TestFlight expiration"
                ),
            ...
            dialog.addAction(
                UIAlertAction(
                    title: NSLocalizedString(
                        "OK",
                        bundle: .main,
                        comment: "Text for ok action on notification of upcoming TestFlight expiration"
                    ),
                    style: .default,
                    handler: nil
                )
            ...
            dialog.addAction(
                UIAlertAction(title: NSLocalizedString(
                    "More Info",
                    bundle: .main,
                    comment: "Text for more info action on notification of upcoming TestFlight expiration"
                ),
                              style: .default,
                              handler: {_ in
            ...
            dialog = UIAlertController(
                title: NSLocalizedString(
                    "Profile Expires Soon",
                    bundle: .main,
                    comment: "The title for notification of upcoming profile expiration"
                ),
                message: alertMessage,
                preferredStyle: .alert
            )
            dialog.addAction(
                UIAlertAction(
                    title: NSLocalizedString(
                        "OK",
                        bundle: .main,
                        comment: "Text for ok action on notification of upcoming profile expiration"
                    ),
                    style: .default,
                    handler: nil
                )
            ...
            dialog.addAction(
                UIAlertAction(title: NSLocalizedString(
                    "More Info",
                    bundle: .main,
                    comment: "Text for more info action on notification of upcoming profile expiration"
                ),
                              style: .default,
                              handler: { _ in
        ...
        if isTestFlightBuild() {
            return String(
                format: NSLocalizedString(
                    "%1$@ will stop working in %2$@. You will need to rebuild before that.",
                    bundle: .main,
                    comment: "Format string for body for notification of upcoming expiration. (1: app name) (2: amount of time until expiration"
                ),
            ...
            return String(
                format: NSLocalizedString(
                    "%1$@ will stop working in %2$@. You will need to update before that, with a new provisioning profile.",
                    bundle: .main,
                    comment: "Format string for body for notification of upcoming provisioning profile expiration. (1: app name) (2: amount of time until expiration"
                ),
                Bundle.main.bundleDisplayName,
                timeUntilExpirationStr
            )
    ...
    static func createProfileExpirationSettingsMessage(expirationDate: Date) -> String {
        ...
        let relativeTimeRemaining: String = readableRelativeTime ?? NSLocalizedString(
            "Unknown time",
            bundle: .main,
            comment: "Unknown amount of time in settings' profile expiration section"
        )
        let verboseMessage = createVerboseAlertMessage(timeUntilExpirationStr: relativeTimeRemaining)
        let conciseMessage = relativeTimeRemaining + NSLocalizedString(
            " remaining",
            bundle: .main,
            comment: "remaining time in setting's profile expiration section"
        )
